package com.wang.bilaccount.widget;
...
import com.wang.bilaccount.util.DensityUtils;
import com.wang.bilaccount.util.SVGUtil;
...
public class IconImageView extends FrameLayout {
    ...
    public IconImageView(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        addView(iv);
        LayoutParams fl = (LayoutParams) iv.getLayoutParams();
        fl.gravity = Gravity.CENTER;
        fl.width = DensityUtil.dp2px(22);
        fl.height =DensityUtil.dp2px(22);
