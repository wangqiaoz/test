...
public class SVGUtil {
    ...
    * */
    public static void setSvgImageTint(@DrawableRes int resId, @ColorRes int color, ImageView imageView) {
        ...
        VectorDrawableCompat vectorDrawableCompat = VectorDrawableCompat.create(MyApp.getInstence().getResources(), resId, MyApp.getInstence().getTheme());
        if (vectorDrawableCompat != null) {
            vectorDrawableCompat.setTint(MyApp.getInstence().getResources().getColor(color));
