...
public class DatePickDialogStartEnd extends Dialog implements OnChangeLisener {
    ...
    public DatePickDialogStartEnd(Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.datepick_dialog_startend);

        initView();
        initParas();
    }

    private DatePicker getDatePicker(DatePicker picker) {

        picker.setStartDate(startDate);
        picker.setYearLimt(20);
    ...
    private void initView() {
        ...
        mDatePickerStart = (DatePicker) findViewById(R.id.date_start);
        mDatePickerStart.setStartDate(startDate);
        mDatePickerStart.setYearLimt(20);
        mDatePickerStart.setOnChangeLisener(this);
        mDatePickerStart.init();
        mDatePickerEnd=(DatePicker)findViewById(R.id.date_end);
        mDatePickerEnd.setStartDate(startDate);
        mDatePickerEnd.setYearLimt(20);
        mDatePickerEnd.setOnChangeLisener(this);
        mDatePickerEnd.init();
